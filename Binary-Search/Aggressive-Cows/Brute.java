...
public class Brute {
    ...
    public static int aggressiveCows(int[] stalls, int k) {
        ...
        // 7. helper func will place cows in stalls and check if the min dist is greater or equal to min dist, if yes then cows will be incremented that means cow has been placed
        // 8. Atlast check if all cows placed or not and similarly return true or false based on the check
        // 9. if true is returned that means we have to keep going on till we get min dist at which we cant place all cows 
        // 10. if false then stop loop and get out of it
    ...
    public static boolean helper(int[] stalls, int n, int minDist, int k) {
        int cows = 1;
